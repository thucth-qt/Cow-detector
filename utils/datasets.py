...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640, auto_size=32, lower=0, upper=1):
    ...
    def __next__(self):
        ...
        img = img0.copy()
        img[:int(self.lower*h),:,:]=0
        img[int(self.upper*h):,:,:]=0
        img = letterbox(img, new_shape=self.img_size, auto_size=self.auto_size)[0]
