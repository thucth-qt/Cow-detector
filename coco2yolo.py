...
if __name__=="__main__":
    ...
    convert_coco_json_to_yolo_txt("/content/Cow-detector/dataset/Sub-levels/Detection_and_localisation/Test/labels/val/","/content/Cow-detector/dataset/Sub-levels/Detection_and_localisation/Test/annotations/instances_val.json")
